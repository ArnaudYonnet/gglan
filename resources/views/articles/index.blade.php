            ...
            <div class="col-md-12 col-lg-6 col-sm-10 pl-lg-5 pl-md-0">
                <div class="featured-article">
                    <a href="/articles/{{ $articles[0]->id }}">
                        <img src="{{ $articles[0]->image_article }}" style="width: 482px; height: 350px;" class="thumb">
                    </a>
            ...
            <ul class="media-list main-list">
                @isset($articles[1])
                    ...
                    <a class="pull-left" href="/articles/{{ $articles[1]->id }}">
                        <img class="media-object" src="{{ $articles[1]->image_article }}" style="width: 150px; height: 90px;">
                    </a>
                ...
                @isset($articles[2])
                    ...
                    <a class="pull-left" href="/articles/{{ $articles[2]->id }}">
                        <img class="media-object" src="{{ $articles[2]->image_article }}" style="width: 150px; height: 90px;">
                    </a>
                    <div class="media-body">
                ...
                @isset($articles[3])
                    <li class="media">
                        ...
                        <img class="media-object" src="{{ $articles[3]->image_article }}" style="width: 150px; height: 90px;">
                        </a>
                        <div class="media-body">
